...
export default class FormSerie extends React.Component {
  ...
  PublicarReview = async() => {
    let review =  {
      ...
      Num_capitulos: this.state.num_cap,
      Duracion_cap: this.state.dur_cap,
    ...
    if(this.comprobar()) {      
      try {
        const response = await fetch('https://reviewzone.azurewebsites.net/api/Serie', {
          method: 'post',
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <ScrollView>
            ...
            <RadioButton.Group
              onValueChange={valor => this.setState({ value: valor })}
            ...
            <Input
              ...
              placeholderTextColor="#fff"
              autoCapitalize="none"
              onChangeText={(value) => this.SaveState("direccion", value)}
            />
            ...
            <Input
              ...
              placeholderTextColor="#fff"
              autoCapitalize="none"
              onChangeText={(value) => this.SaveState("guion", value)}
            />
